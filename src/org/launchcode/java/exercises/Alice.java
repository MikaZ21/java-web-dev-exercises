...
public class Alice {
    public static void main(String[] args) {
        ...
        System.out.println("The first sentence contains your search ");

        int index = firstSentence.indexOf(searchTerm);
        int length = searchTerm.length();
        System.out.println("Your search term first appears at index "
                + index + ". Your term is " + length + "characters long.");
